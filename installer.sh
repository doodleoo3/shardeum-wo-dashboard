#!/usr/bin/env bash
echo "alias sh_status='docker exec -it shardeum-dashboard sh -c \"operator-cli status\"'" >> ~/.bash_profile
echo "alias sh_start='docker exec -it shardeum-dashboard sh -c \"operator-cli start\"'" >> ~/.bash_profile
echo "alias sh_stop='docker exec -it shardeum-dashboard sh -c \"operator-cli stop\"'" >> ~/.bash_profile
echo "alias sh_stake='docker exec -it shardeum-dashboard sh -c \"operator-cli stake 10\"'" >> ~/.bash_profile
echo "alias sh_unstake='docker exec -it shardeum-dashboard sh -c \"operator-cli unstake\"'" >> ~/.bash_profile
